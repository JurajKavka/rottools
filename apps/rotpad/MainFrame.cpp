...
MainFrame::MainFrame(wxWindow* parent) : MainFrameWx(parent) {
    ...
    m_textEditorPanel->SetEditorFont(rottools::ApplicationConfig::LoadEditorFont(m_textEditorPanel->GetEditorFont()));
...
void MainFrame::HandleFontMenuItemClick(wxCommandEvent& event) {
    ...
    if (fontDialog.ShowModal() == wxID_OK) {
        ...
        if (chosenFont.IsOk()) {
            ...
            rottools::ApplicationConfig::SaveEditorFont(chosenFont);
        }
    }
